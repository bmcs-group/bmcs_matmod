...
class GSMSymbBox:
    ...
    **Engineering Significance:**
    ...
    def _apply_constitutive_substitutions(self, 
        ...
        # Identify variables that need to be exchanged (present in from_natural but not in to_natural)
        ...
        if T in from_natural and T not in to_natural:
            ...
            try:
                ...
                if T_expr:
                    ...
                    variables_to_substitute.append((T, T_expr[0]))
            ...
            # Compute: T = ∂F/∂S, then solve for S = f(T)  
            ...
            try:
                ...
                if S_expr:
                    ...
                    variables_to_substitute.append((S, S_expr[0]))
            except (sp.SolvableError, NotImplementedError):
                pass
            ...
            if eps_i in from_natural and eps_i not in to_natural:
                ...
                try:
                    ...
                    if eps_expr:
                        ...
                        variables_to_substitute.append((eps_i, eps_expr[0]))
                except (sp.SolvableError, NotImplementedError):
                    pass
            elif sig_i in from_natural and sig_i not in to_natural:
                # Need to substitute sig in terms of eps
                # Compute: ε = -∂(original_expr)/∂σ, then solve for σ = f(ε)
                ...
                try:
                    ...
                    if sig_expr:
                        ...
                        variables_to_substitute.append((sig_i, sig_expr[0]))
                except (sp.SolvableError, NotImplementedError):
                    pass
