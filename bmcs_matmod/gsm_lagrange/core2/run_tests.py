...
This script provides a convenient way to run the GSMSymbBox tests with different
...
def run_tests(test_args=None, coverage=False, verbose=False):
    ...
    if coverage:
        cmd.extend(["--cov=gsm_symb_box", "--cov-report=html", "--cov-report=term"])
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run GSMSymbBox tests",
